package com.nallani.infoserver.rest;

import java.util.ArrayList;
import java.util.List;

import com.nallani.infoserver.model.*;
...
public class EmployeeDataController
{
    ...
    public EmployeeAddresses getAddresses()
    {
        ...
        {
            employeeAddress1.setHouseNo("11");
            employeeAddress1.setStreetNo("1");
            employeeAddress1.setZipCode("11111");

            employeeAddress2.setHouseNo("2");
            employeeAddress2.setStreetNo("22");
    ...
    public EmployeePhone getPhoneNumbers()
    {
        ...
        EmployeePhone employeePhone = new EmployeePhone();
        {
            ...
            phoneNumberList.add("100100100");
            phoneNumberList.add("200200200");
    ...
    public EmployeeNames getEmployeeName()
    {
        ...
        {
            employeeName1.setFirstName("Sri");
            employeeName1.setLastName("N");
        }
        {
            employeeName2.setFirstName("N");
            employeeName2.setLastName("Sri");
        }
